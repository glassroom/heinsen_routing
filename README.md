...
Most of the research we do at GlassRoom tends to be tightly coupled to internal code and/or of a proprietary nature, so we cannot share it with others. This is the first time we have worked on something that (a) we believe could be valuable to others, (b) we can release as stand-along open-source software, evaluate on publicly available academic datasets, and write up in a paper, and (c) is new, original research.
